...
6. In summary, architectural design contributes significantly to adversarial robustness, particularly the block
...
comments: it is like a prototype model but learn the concepts with language model.
