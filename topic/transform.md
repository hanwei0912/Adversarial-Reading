...
inference. (Towards Patch adversarial examples)
...
[code](https://github.com/KlugerLab/adversarial-examples)

1. Level 1 wavelet approx.
2. low-pass filter
3. JPEG
4. PCA
5. Soft-thresholding
...
![daf](figures/homogeneity.png)

[code](https://github.com/LiYingwei/Regional-Homogeneity)

### [DIPDefend: Deep Image Prior Driven Defense against Adversarial Examples](https://dl.acm.org/doi/pdf/10.1145/3394171.3413898?casa_token=g8kJzzXJ5YoAAAAA:8ZldFqoaJZkgHdcWH3PeldOlxfd5HFLfNMVyI-p7pRwuxLBh5SOLKqc_TmjmCiyfdgfc3Kp4qQ5e)
...
![daf](figures/super.png)
![daf](figures/super1.png)
...
![img](figures/clearnQuantized.png)
